							...
							<div className="container">
								<div className="row justify-content-center">
									<div className="col-md-8">
										{/* Start Heading Title */}
										<div className="heading-title text-center">
											<h2 className="f-weight-700 margin-0">Cinematography By</h2>
											<div className="bordershep" />
											<a rel="noreferrer" target="_blank" href="http://artnest.in">
												<LazyImage src="assets/images/ticketpartner/artnest.png" imgClassName="cinemetography-img img-fluid"/>
											</a>
										</div>
										{/* End Heading Title */}
									</div>
