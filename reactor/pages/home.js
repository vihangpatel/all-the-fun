...
const Home = () => {
	const [loadVideo, setFlag] = useState(false)
						...
						<div className="col-md-12 order-last order-md-first">
							<div className="about-text">
								<p className="first-text">
									React India is a community led non profit initiative with international flavor. The
									first of its kind in India, the event consists of a workshop day and two days of
									talks around the topic.
								</p>
								<p>
									A 3 day conference with first day focussing on workshops & next 2 days talks on
									things around React, React Native & GraphQL. This edition would be gathering
									Front-end and Full-stack developers across the globe in the cool place of India. In
									this single track event you will learn more about React and surrounding topics while
									meeting some of the leading talents around the globe. In addition to enjoying the
									event, this is your chance to explore Goa. Regular and lightning talks will cover
									various React.JS and FE topics including React Native, GraphQL, VR & AR, Redux,
									Preact and more!
								</p>
					...
					<div className="row justify-content-center">
						<div className="col-md-8">
							...
							<div className="heading-title text-center">
								...
								<div className="bordershep" />
								<p>
									Our Attendees, Speakers & Sponsors will be able to meet together and share a few
									exciting and fruitful days, while enjoying the food and warm weather from the
