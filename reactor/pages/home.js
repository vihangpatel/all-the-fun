...
const Home = () => {
	const [loadVideo, setFlag] = useState(0)
						...
						<div className="col-md-6 order-last order-md-first">
							<div className="about-text">
								<p className="first-text">
									There are many variations of passages of Lorem Ipsum available but the at majority
									have suffered alteration in some dummy.
								</p>
								<p>
									There are many variations of passages of Lorem Ipsum available, but the majority
									have suffered alteration in some form, by injected humour or at randomised words
									which don't look even slightly believable. If you are an going to use a passage of
