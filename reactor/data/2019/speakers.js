const data = [
  ...
  },
  {
    name: "Yash Gupta",
    imgPath: "yash.png",
    github: "https://github.com/yashguptaz",
    twitter: "https://twitter.com/yashguptaz",
    description: "Student. Freelancer. Web Developer. Self-taught.",
    jobrole: "Student"
  },
  {
    name: "Jani Eväkallio",
  ...
  },
  {
    ...
    description:
      "React enthusiast, been writing Javascript for the past decade",
  ...
  },
  {
    ...
    description:
      "Carolyn Stransky is a frontend developer based in Berlin, Germany. She currently works at Blacklane, organizes BerlinJS and teaches at ReDI School of Digital Integration. You’ll usually find her looking at memes or taking selfies in the nearest restroom.",
  ...
  },
  {
    ...
    description:
      "Works on AMP ⚡️⚡️⚡️. Mobile web lover/developer , matching web against every native. @google-r, ex @flipkart-ian, @workboxjs-er Preact-cli core team member.",
    jobrole: "Google, User experience engineer",
    tinySrc:
      "data:image/jpeg;base64,"
  },
  {
    name: "Kiran Abburi",
    ...
    description:
      "Kiran Abburi works as a consultant primarily on Reactjs and GraphQL projects. He contributes to open source projects and organises reactjs Bangalore meetup, which is an active meetup group with 9000 members",
  ...
  },
  {
    ...
    description:
      "JavaScript enthusiast. I believe in the web and enjoy building experiences that leverage the best it has to offer. An avid Chelsea Football Club fan and anime lover.",
  ...
  },
  {
    ...
    description:
      "Shahidh is an Engineer at Hasura and is a maintainer for the open-source Hasura GraphQL Engine. A Design Engineer by training, his current focus is on various software design patterns and their applications in making better developer tools and workflows. He is also the co-author of a popular GraphQL CLI tool called Graphqurl.",
  ...
  },
  {
    ...
    description:
      "Ritesh loves to write code, play keyboard and paint. He is currently working on open source projects involving developer tooling, design systems, and music.",
  ...
  },
  {
    ...
    description:
      "Ananya is a frontend developer who loves to design with code. She is passionate about the web, design and everything at its intersection. Also loves dogs.",
  ...
  },
  {
    ...
    description:
      "Engineer at heart, works on Web, React, GraphQL and everything out there. Ready to learn something new, like always! Have ideas about education, yoga, philosophy and deal with these in spare time.",
  ...
  },
  {
    ...
    description:
      "I am Abinash, engineer in the Ads Platform team (previously core team member of Flipkart Lite PWA team) at Flipkart. Interested in web performance and striving to make web a better place.",
  ...
  },
  {
    ...
    description:
      "Tomasz is a Senior Frontend Developer at OLX Group. Tech speaker, egghead.io instructor, jQuery evangelist. His interests include React, VR, e2e testing, app performance and making cheesiest jokes known to mankind.",
